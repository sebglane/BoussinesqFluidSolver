...
private:
    ...
    std::vector<double>    compute_benchmark_requests_locally() const;
    std::vector<double>    compute_benchmark_requests() const;
    ...
    double                          timestep;
    double                          old_timestep;
    double                          old_old_timestep;
    double                          old_alpha_zero;
    double                          old_old_alpha_zero;
